USE [MySystem]
GO
/****** Object:  StoredProcedure [dbo].[DeleteUser]    Script Date: 01/09/2026 03:06:43 PM ******/
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS (SELECT 1 FROM Users WHERE UserID = @ID)
    BEGIN
        RAISERROR('error accured aasdasd', 16, 1);
        RETURN;
    END
...
END CATCH;
GO
/****** Object:  StoredProcedure [dbo].[GetUsers]    Script Date: 01/09/2026 03:06:43 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN CATCH
    ...
    END CATCH;
GO
/****** Object:  StoredProcedure [dbo].[InsertUpdateUser]    Script Date: 01/09/2026 03:06:43 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
